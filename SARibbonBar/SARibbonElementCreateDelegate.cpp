...
{
    mainbarHeightOfficeStyleThreeRow = 160+24;
    mainbarHeightWPSStyleThreeRow = 130 + 24;
    mainbarHeightOfficeStyleTwoRow = 134 + 24;
    mainbarHeightWPSStyleTwoRow = 104 + 24;
    titleBarHight = 30;
    tabBarHight = 25 + 11;
    //titleTextColor = Qt::black;
    titleTextColor = Qt::white;
    widgetBord = QMargins(0, 1, 0, 0);  //ribbon 边框大小，原始数据(5, 1, 5, 5)
