...
public:
	...
	// -------------------------------------------------------------------------------
	explicit Database() {};
	int initV2(const std::string& dbFile, std::string& strErr, const int flag = SQLite::OPEN_READONLY, const int busyTimeOut = 0, const std::string& vfs = "");
	int init(const std::string& dbFile, std::string& strErr, const int flag = SQLite::OPEN_READONLY);
	// -------------------------------------------------------------------------------
	...
	bool tableColumnExists(const char* apTableName,const char* apColumnName);
